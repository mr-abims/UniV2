...
// import "../src/UniV2.sol";
// // import "./mocks/ERC20Mintable.sol";

// contract CuniswapV2PairTest is Test {
...
//         pair = new CuniswapV2Pair(address(token0), address(token1));
...
//         CuniswapV2Pair(pairAddress_).mint();
//     }

//     function withdrawLiquidity(address pairAddress_) public {
//         CuniswapV2Pair(pairAddress_).burn();
//     }
// }
